...
# saveRDS(missing_chg_data_trend_5days, "missing_chg_data_trend_5days.rds")
# saveRDS(missing_chg_data_trend_downtown_5days, "missing_chg_data_trend_downtown_5days.rds")

missing_chg_data_trend_5days <- as.data.frame(readRDS("missing_chg_data_trend_5days.rds"))
missing_chg_data_trend_downtown_5days <- as.data.frame(readRDS("missing_chg_data_trend_downtown_5days.rds"))
...
# 
# vol_trending_3 <- vol_trending %>%
#   group_by(Campus, Appt.Year) %>%
#   summarise(total = sum(total)) %>%
#   pivot_wider(names_from = Appt.Year,
#               values_from = total) %>%
...
vol_trending <- readRDS("vol_trending.rds")

# saveRDS(vol_trending, "vol_trending.rds")
...
vol_trending_downtown <- readRDS("vol_trending_downtown.rds")

# saveRDS(vol_trending_downtown, "vol_trending_downtown.rds")
...
new_vol_trending_downtown <- readRDS("new_vol_trending_downtown.rds")

# saveRDS(new_vol_trending_downtown, "new_vol_trending_downtown.rds")
...
missing_ytd_data <- readRDS("missing_ytd_data.rds")

# saveRDS(missing_ytd_data, "missing_ytd_data.rds")
