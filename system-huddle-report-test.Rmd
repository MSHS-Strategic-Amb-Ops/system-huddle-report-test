...
hh_data_comp_raw <- as.data.frame(readRDS("/nfs/data/Applications/Ambulatory/Data_Updated/hh_data_comp_raw.rds"))
hh_data_comp_raw_pt_entry <- as.data.frame(readRDS("/nfs/data/Applications/Ambulatory/Data_Updated/hh_data_comp_raw_pt_entry.rds"))

print(hh_data_comp_raw)
