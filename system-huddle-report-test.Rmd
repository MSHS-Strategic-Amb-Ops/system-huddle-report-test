...
vol_trending_site <- vol_trending %>%
...
vol_trending <- bind_rows( vol_trending_mshs, vol_trending_site)
...
new_vol_trending <- bind_rows(new_vol_trending_mshs, new_vol_trending_site)
...
hh_site <- bind_rows(hh_mshs, hh_site)
